...
void		INISG_FUNC( createIni	)		(ini_t**);
...
void INISG_FUNC( createIni ) (ini_t** iniptr) {
	if(*iniptr == NULL) *iniptr = INISG_MEM(malloc)(sizeof(ini_t));
	(*iniptr)->numSections = 0;
	(*iniptr)->sections = NULL;
}
